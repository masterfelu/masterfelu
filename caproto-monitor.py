"""
patched version of 
https://github.com/caproto/caproto/blob/master/caproto/commandline/monitor.py
patched to run outside caproto and send notification on mac (see line 188-207)
...
from caproto import SubscriptionType, __version__, set_handler
from caproto._log import _set_handler_with_logger
from caproto._utils import ShowVersionAction
from caproto.client.common import GLOBAL_DEFAULT_TIMEOUT
from caproto.sync.client import block, subscribe
from caproto.commandline.cli_print_formats import (clean_format_args, format_response_data,
